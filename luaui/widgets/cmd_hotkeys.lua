function widget:GetInfo()
	return {
		name = "Hotkeys",
		desc = "Enables Hotkeys, including ZXCV,BN,YJ,O,Q" ,
		author = "Beherith",
		date = "23 march 2012",
...
function widget:Initialize()
    ...
    WG.Reload_Hotkeys = ReloadBindings
end

function widget:Shutdown()
    UnloadBindings()
    WG.Reload_Hotkeys = nil

    if widgetHandler.orderList and (widgetHandler.orderList["Hotkeys -- swap YZ"] or 0) > 0 then
        widgetHandler:DisableWidget("Hotkeys -- swap YZ")
    end
end
